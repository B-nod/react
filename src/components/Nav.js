    ...
    return (
        <>
            <div className="container-fluid">
                <div classNameName="row bg-secondary align-items-center">
                    <div className="col-lg-2">
                        <Link className="navbar-brand text-white" to="index.html">Ecommerce</Link>
                    </div>
                    ...
                    <div className="col-lg-3">
                        <div className="d-flex">
                            <div className="offset-sm-2 col-sm-3 col-lg-3">
                                <Link to="signin.html" className="text-decoration-none text-white" title="signin">
                                    <i className="fas fa-sign-in-alt fs-3 my-3"></i>
                                </Link>
                            </div>
                            <div className="col-sm-3 col-lg-3">
                                <div className="col-lg-4">
                                    <Link to="signup.html" className="text-decoration-none text-white" title="signup">
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to="/service">Customer Service</Link>
                            </li>
                        </ul>
